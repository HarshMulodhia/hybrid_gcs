...
class TestPolicyNetworkConfig:
    ...
    def test_creation_default(self):
        ...
        config = PolicyNetworkConfig(state_dim=6, action_dim=2)
    ...
    def test_creation_custom(self):
        ...
        config = PolicyNetworkConfig(
            state_dim=10, action_dim=4, hidden_dim=128, num_hidden_layers=2
        )
...
class TestCNNEncoder:
    ...
    def test_creation(self):
        ...
        encoder = CNNEncoder(input_channels=3, channels=[16, 32, 64], output_dim=256)
...
class TestPolicyNetwork:
    ...
    def policy(self):
        ...
        config = PolicyNetworkConfig(
            state_dim=6, action_dim=2, hidden_dim=64, num_hidden_layers=2, device="cpu"
        )
...
class TestPolicyNetworkWithLSTM:
    ...
    def policy_lstm(self):
        """Create LSTM policy."""
        config = PolicyNetworkConfig(state_dim=6, action_dim=2, hidden_dim=64, device="cpu")
...
class TestPolicyNetworkIntegration:
    ...
    def test_gradient_flow(self):
        ...
        config = PolicyNetworkConfig(state_dim=6, action_dim=2, device="cpu")
        policy = PolicyNetwork(config)
