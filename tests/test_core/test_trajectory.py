...
from hybrid_gcs.core import BezierTrajectory, Trajectory
...
class TestTrajectoryInterpolation:
    ...
    @pytest.fixture
    def trajectory(self):
        waypoints = np.array([[0.0, 0.0], [5.0, 5.0], [10.0, 0.0]])
        return Trajectory(waypoints)
...
class TestBezierTrajectory:
    ...
    def bezier(self):
        ...
        control_points = np.array([[0.0, 0.0], [1.0, 2.0], [2.0, 0.0]])
...
class TestTrajectorySmoothing:
    ...
    def noisy_trajectory(self):
        ...
        waypoints = np.array([[0.0, 0.0], [1.0, 0.5], [2.0, 0.0], [3.0, 0.5], [4.0, 0.0]])
        return Trajectory(waypoints)
